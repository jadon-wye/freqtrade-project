...
class MovingAverageCrossStrategy(IStrategy):
    # 파라미터 선언
    ema_short_period = IntParameter(5, 20, default=12, space="buy", optimize=False)
    ema_long_period = IntParameter(25, 100, default=35, space="buy", optimize=False)
